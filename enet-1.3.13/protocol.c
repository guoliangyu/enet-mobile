...
// chenglong: 辅助unity代码测试wrapper用的，返回一系列内部struct的大小
int enet_struct_size(enet_uint8 id)
{
	switch (id)
	{
	case 0:
		return sizeof(ENetListNode);
	case 1:
		return sizeof(ENetList);
	case 2:
	...
	case 15:
		return sizeof(ENetProtocol);
	case 16:
		return sizeof(ENetAddress);
	case 17:
		return sizeof(ENetBuffer);
	case 18:
		return sizeof(ENetPacket);
	case 19:
		return sizeof(ENetCompressor);
	case 20:
		return sizeof(ENetPeer);
	case 21:
		return sizeof(ENetHost);
	case 22:
